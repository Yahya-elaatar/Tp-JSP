 ...
 <form action="FiliereController" method="post" >
  <div class="container">
            ...
            <div class="col-3">
                ...
                <input type="text" id="code" name="code" value="${filiere.code}" class="form-control "   required>
            </div>
            <div  class="col-3 mb-3">
                <label for="name" class="form-label">Name:</label>
                <input type="text" id="name" name="name" value="${filiere.name}" class="form-control "  required>
            </div>
			<input type="hidden" name="_method" value="${type}">
			<input type="hidden" name="filiereToUpdate" value="${filiere.id}">
      ...
      <td>
      	...
      	<div style="display: flex; gap: 10px;">
						        <form action="FiliereController" method="post">
						            ...
						            <input type="hidden" name="filiereToDelete" value="${f.id}">
						            <button type="submit" class="btn btn-danger">Delete</button>
						        </form>
						        <form action="FiliereController" method="post">
						            <input type="hidden" name="_method" value="findAll">
						            <input type="hidden" name="filiereToGet" value="${f.id}">
